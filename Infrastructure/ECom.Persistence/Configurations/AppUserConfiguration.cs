...
internal class AppUserConfiguration : IEntityTypeConfiguration<AppUser>
{
    public void Configure(EntityTypeBuilder<AppUser> builder)
    {
        ...
        var user1 = new AppUser() { Id = 1, FirstName = "Oğuzhan", LastName = "Söğünmez", Email = "ouz@seeddata.com", EmailConfirmed = true, NormalizedEmail = " OUZ@SEEDDATA.COM", UserName = "ogzhnsgnmz", PhoneNumber = "0541 555 ####", NormalizedUserName = "OGZHNSGNNMZ", PasswordHash = hasher.HashPassword(null, "Customer1*123"), SecurityStamp = Guid.NewGuid().ToString("D") };
