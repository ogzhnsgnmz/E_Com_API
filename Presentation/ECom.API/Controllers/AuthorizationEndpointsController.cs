using ECom.Application.Features.Command.AuthorizationEndpoint.AssignRoleEndpoint;
using ECom.Application.Features.Queries.AuthorizationEndpoint.GetRolesToEndpoint;
using MediatR;
